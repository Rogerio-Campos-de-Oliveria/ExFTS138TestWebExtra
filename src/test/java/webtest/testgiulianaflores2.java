...
public class testgiulianaflores2 {
    WebDriver driver;
    ...
    public void testAcessoProduto(){
        ...
        driver.findElement(By.cssSelector("div.box_calendario_popup"));
        driver.findElement(By.cssSelector("data_dia jCalendarDate"));
        driver.findElement(By.partialLinkText("2024.01.19")).click();
        driver.findElement(By.cssSelector("Comercial (08:00 às 19:00)")).click();
